...
//
#define	BUTTON_ATTACK		1	//Button 0
#define	BUTTON_FORCE_LIGHTNING	2	// Button 1 displays talk balloon and disables actions
#define	BUTTON_USE_FORCE	4	//Button 2
#define	BUTTON_BLOCKING		8	//Button 3
